...
# -------- EKS cluster (TIMEOUTS + PUBLIC ACCESS FIXED) --------
...
# -------- Node groups (TIMEOUTS + LAUNCH TEMPLATE FIXED) --------
...
# Data sources (region first)
data "aws_region" "current" {}

# Data sources for Helm provider (post-cluster)
